export const journey = [
    {
        ...
        <p className='pt-10'>After their first contract, which was awarded by the then SRC women’s Commissioner of KNUST namely Miss. Ruth Anku-Gbetanu, a lot of orders came in from other organisations such as the Medical Students Association (KNUST), Social Sciences Students Association, and the National Union of Ghana Students (NUGS_KNUST). News about PIZZAMAN began to spread as it was a bit surprising to see a former Presidential aspirant of the KNUST students Representative Council engaging in a food business.</p>`
    },
